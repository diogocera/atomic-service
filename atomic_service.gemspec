Gem::Specification.new do |spec|
  ...
  spec.description = "A base class to build DRY service objects in Ruby with a little help form activemodel."
  spec.authors     = ["Diogo Cera"]
  spec.email       = 'diogocera@gmail.com'
  spec.files       = ["lib/atomic_service.rb"]
  spec.homepage    = 'https://rubygems.org/gems/atomic_service'
  spec.license     = 'MIT'
